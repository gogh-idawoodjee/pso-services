...
return [
    ...
    'title' => 'PSO Services API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'Middleware API for IFS/PSO Scheduling operations.',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<'INTRO'
            PSO Services acts as a middleware layer between clients and the IFS/PSO Scheduling API.

            All endpoints accept a common `environment` block containing connection details (`baseUrl`, `datasetId`, `accountId`, auth credentials) and a `data` block with endpoint-specific parameters.

            Set `environment.sendToPso` to `false` for a dry-run that returns the built payload without sending it to PSO.
        INTRO,
